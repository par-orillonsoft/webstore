...
<div id="divLogo" style="<?= $colorLogoBackground.$colorLogoBorder ?>">
	<img id="imgBanner" src="<?= $logoUrl ?>" style="border-width:0px;" />
</div>
<?php endif; ?>
...
<form id="cayanForm" class="myForm" autocomplete="off" style="<?= $colorContainerBackground.$colorContainerBorder ?>">
	<div id="divCardEntry">
		...
		<div id="divCustomButtons" class="buttonMargin">
			<input type="image" name="btnProceed" id="btnProceed" tabindex="9" title="Click here to submit this transaction." class="button" src="https://transport.merchantware.net/v4/style/buttons/submit.gif" style="border-width:0px;" />
			<input type="image" name="btnCancel" id="btnCancel" tabindex="10" title="Click here to cancel this transaction." class="button" src="https://transport.merchantware.net/v4/style/buttons/cancel2.gif" style="border-width:0px;" />
		</div>
